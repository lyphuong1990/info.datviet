...
//		processPostBDSJS(url);
	...
	public static JSONArray getDeatil(int productId) {
		...
		try {
			System.out.println("https://www.batdongsan.com.vn/HandlerWeb/APIAccountHandler.ashx?type=ProductDetail&productId="
					+ productId);
			json = Helper.readUrl(
			...
			// TODO Auto-generated catch block
			Helper.writeLog4j("https://www.batdongsan.com.vn/HandlerWeb/APIAccountHandler.ashx?type=ProductDetail&productId="
							+ productId);
			Helper.writeLog4j(e.toString());
			return jsonarray;
		}
